...
echo "Checking VPS"
IZIN=$(curl https://raw.githubusercontent.com/daneshswara29/VPN/main/ipvps.txt | grep $MYIP | awk '{print $3}')
if [ $MYIP = $MYIP ]; then
...
clear
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/daneshswara29/VPN/main/backup"
