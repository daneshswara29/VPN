...
```
wget https://raw.githubusercontent.com/daneshswara29/VPN/main/setup.sh && chmod +x setup.sh && ./setup.sh
```
...
```
wget https://raw.githubusercontent.com/daneshswara29/VPN/main/menu/updated/getupdate.sh && chmod +x getupdate.sh && getupdate.sh
```
